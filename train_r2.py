...
def main():
    ...
    for epochs in range(total_epochs):
        ...
        if epochs % 10 == 0:
            save_model_path = model_path + "/MSCN_V2_e{}_lr{}_loss{:4}.pt".format(epochs,lr,loss)
    ...
    save_model_path = model_path + "/MSCN_V2_e{}_lr{}.pt".format(epochs, lr)
    torch.save(MODEL, save_model_path)
